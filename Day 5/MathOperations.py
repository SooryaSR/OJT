#Create a class called MathOperations with class methods for
# basic mathematical operations like addition, subtraction, multiplication, and a static method to find the factorial of a number
